...
// import pagi from './main_assets/punjabi.jpeg';
...
//             className="w-full p-2 sm:p-3 border rounded-md mb-3 sm:mb-4 text-gray-700 bg-white text-sm sm:text-base"
//           />
//           <button className="w-full bg-yellow-400 text-black font-semibold py-2 sm:py-3 rounded-full hover:bg-yellow-500 transition text-sm sm:text-base">
//             Sign In
//           </button>
//         </form>
