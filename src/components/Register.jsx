    ...
    <div className="flex flex-col md:flex-row h-screen w-full">
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-b from-[#F09918] to-[#1077BC] flex flex-col items-center justify-center px-6 py-10">
        ...
        <form className="w-full max-w-xs" onSubmit={onSubmitHandler}>
          ...
          <button
            type="submit"
            className="w-full bg-[#FF9E2F] text-black font-semibold py-3 rounded-full hover:bg-orange-700 transition"
          >
            Verify & Register
          </button>
        </form>
        ...
        <p className="text-gray-300 text-sm mt-4">
          ...
          <Link to="/Login" className="text-[#FF9E2F] hover:underline">
            Sign Up
          </Link>{" "}
        </p>
      </div>
